...
class Title {
  constructor({ gl, plane, text, textColor = '#064e3b', font = 'bold 30px sans-serif' }) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
    this.text = text;
...
class GalleryApp {
  constructor(
    ...
    this.onResize();
    this.createGeometry();
    this.createMedias(this.items, bend, textColor, borderRadius, font);
    this.update();
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    ...
    this.mediasImages = galleryItems.length > 1 ? galleryItems.concat(galleryItems) : galleryItems;
